...
begin
  TPedidosValidator.Validate(self, aValidated);
end;
...
class procedure TPedidosValidator.Validate(aToValidate: THelloWorldInput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: THelloWorldInput; aValidated: TList);
begin
...
class procedure TPedidosValidator.Validate(aToValidate: THelloWorldOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: THelloWorldOutput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TCliente);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TCliente; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TServiceStartedPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TServiceStartedPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TNotifyUserEventPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TNotifyUserEventPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TEmailNotifyUserEventPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TEmailNotifyUserEventPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TPushNotifyUserEventPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TPushNotifyUserEventPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TGetMetadataInput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TGetMetadataInput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TGetMetadataOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TGetMetadataOutput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TBlobReference);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TBlobReference; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TBasicErrorPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TBasicErrorPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportError);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportError; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TFielddto);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TFielddto; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: THookdto);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: THookdto; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TLayoutdto);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TLayoutdto; aValidated: TList);
var
  i: Integer;
begin
  if Contains(aValidated, aToValidate) then
...
class procedure TPedidosValidator.Validate(aToValidate: TImportReport);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportReport; aValidated: TList);
var
  i: Integer;
begin
  if Contains(aValidated, aToValidate) then
...
class procedure TPedidosValidator.Validate(aToValidate: TExportEventStatus);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TExportEventStatus; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportEventStatus);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportEventStatus; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TExportConfig);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TExportConfig; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportConfig);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportConfig; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteInput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteInput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteOutput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteInput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteInput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteOutput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteEventPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TImportClienteEventPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteEventPayload);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TExportClienteEventPayload; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TCreateBulkClienteInput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TCreateBulkClienteInput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TCreateBulkClienteOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TCreateBulkClienteOutput; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TDependency);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TDependency; aValidated: TList);
begin
  if Contains(aValidated, aToValidate) then
    Exit;
  aValidated.Add(aToValidate);
...
class procedure TPedidosValidator.Validate(aToValidate: TGetDependenciesOutput);
var
  xValidated: TList;
begin
  xValidated := TList.Create;
...
class procedure TPedidosValidator.Validate(aToValidate: TGetDependenciesOutput; aValidated: TList);
var
  i: Integer;
begin
  if Contains(aValidated, aToValidate) then
...
type
  ...
  { TVarejo_PedidosTypeInfoHelper }

  TVarejo_PedidosTypeInfoHelper = class(TPersistent)
  private
...
begin
  vUserNotificationKindTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'UserNotificationKind').PropType^;
  
  vUserNotificationPriorityTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'UserNotificationPriority').PropType^;
  
  vEventEmailFormatTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'EventEmailFormat').PropType^;
  
  vFieldTypeTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'FieldType').PropType^;
  
  vFileFormatTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'FileFormat').PropType^;
  
  vHookFunctionTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'HookFunction').PropType^;
  
  vEventTypeTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'EventType').PropType^;
  
  vErrorStrategyTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'ErrorStrategy').PropType^;
  
  vStatusTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'Status').PropType^;
  
  vErrorTypeTypeInfo := GetPropInfo(TVarejo_PedidosTypeInfoHelper, 'ErrorType').PropType^;
end;

initialization

  RegisterJsonClass('varejo.pedidos', TBasicErrorPayload);
  RegisterJsonClass('varejo.pedidos', TBlobReference);
  RegisterJsonClass('varejo.pedidos', TCliente);
  RegisterJsonClass('varejo.pedidos', TClientePageRequest);
  RegisterJsonClass('varejo.pedidos', TClientePagedResults);
  RegisterJsonClass('varejo.pedidos', TCreateBulkClienteInput);
  RegisterJsonClass('varejo.pedidos', TCreateBulkClienteOutput);
  RegisterJsonClass('varejo.pedidos', TDependency);
  RegisterJsonClass('varejo.pedidos', TEmailNotifyUserEventPayload);
  RegisterJsonClass('varejo.pedidos', TExportClienteEventPayload);
  RegisterJsonClass('varejo.pedidos', TExportClienteInput);
  RegisterJsonClass('varejo.pedidos', TExportClienteOutput);
  RegisterJsonClass('varejo.pedidos', TExportConfig);
  RegisterJsonClass('varejo.pedidos', TExportEventStatus);
  RegisterJsonClass('varejo.pedidos', TFielddto);
  RegisterJsonClass('varejo.pedidos', TGetDependenciesOutput);
  RegisterJsonClass('varejo.pedidos', TGetMetadataInput);
  RegisterJsonClass('varejo.pedidos', TGetMetadataOutput);
  RegisterJsonClass('varejo.pedidos', THelloWorldInput);
  RegisterJsonClass('varejo.pedidos', THelloWorldOutput);
  RegisterJsonClass('varejo.pedidos', THookdto);
  RegisterJsonClass('varejo.pedidos', TImportClienteEventPayload);
  RegisterJsonClass('varejo.pedidos', TImportClienteInput);
  RegisterJsonClass('varejo.pedidos', TImportClienteOutput);
  RegisterJsonClass('varejo.pedidos', TImportConfig);
  RegisterJsonClass('varejo.pedidos', TImportError);
  RegisterJsonClass('varejo.pedidos', TImportEventStatus);
  RegisterJsonClass('varejo.pedidos', TImportReport);
  RegisterJsonClass('varejo.pedidos', TLayoutdto);
  RegisterJsonClass('varejo.pedidos', TNotifyUserEventPayload);
  RegisterJsonClass('varejo.pedidos', TPushNotifyUserEventPayload);
  RegisterJsonClass('varejo.pedidos', TServiceStartedPayload);
  
  InitializeTypeInfos;
  
  RegisterEnum(vUserNotificationKindTypeInfo, cUserNotificationKindNames, 'varejo.pedidos');
  RegisterEnum(vUserNotificationPriorityTypeInfo, cUserNotificationPriorityNames, 'varejo.pedidos');
  RegisterEnum(vEventEmailFormatTypeInfo, cEventEmailFormatNames, 'varejo.pedidos');
  RegisterEnum(vFieldTypeTypeInfo, cFieldTypeNames, 'varejo.pedidos');
  RegisterEnum(vFileFormatTypeInfo, cFileFormatNames, 'varejo.pedidos');
  RegisterEnum(vHookFunctionTypeInfo, cHookFunctionNames, 'varejo.pedidos');
  RegisterEnum(vEventTypeTypeInfo, cEventTypeNames, 'varejo.pedidos');
  RegisterEnum(vErrorStrategyTypeInfo, cErrorStrategyNames, 'varejo.pedidos');
  RegisterEnum(vStatusTypeInfo, cStatusNames, 'varejo.pedidos');
  RegisterEnum(vErrorTypeTypeInfo, cErrorTypeNames, 'varejo.pedidos');
